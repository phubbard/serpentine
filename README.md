...
quick way plus however long you'll spend on better roads. Status: routing engine and API running in-house; iOS app v0.1 on internal TestFlight as
...
- `server/` — serpentine-api (Go, stdlib only): loops, time budgets, charging, Apple Maps handoff, the
